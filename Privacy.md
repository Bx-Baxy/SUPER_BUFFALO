1. Introduction
This Privacy Policy applies to SUPER BUFFALO SLOTS (the “Game”). We understand the importance of your personal information and are committed to protecting its security. This Policy explains how we collect, use, store, share, and protect your personal information, as well as the rights you may have.
Please read this Privacy Policy carefully before downloading, installing, or using the Game.
2. Information We Collect and How We Use It
To provide our gaming services, we may collect the following types of information:
2.1 Game Functionality Data
Game Progress Data: Including level completion status, player level, experience points, and in-game currency balances, used to save your progress and provide cross-device synchronization.
Device Information: Including device model, operating system version, and unique device identifiers, used to ensure proper game operation, optimize performance, and prevent fraud.
2.2 Account and Login Information (if applicable)
If you choose to log in through a third-party account, we may collect your account identifier to create and verify your game account.
2.3 Payment and Transaction Information (if applicable)
When you make in-game purchases, payment transactions are processed by Apple App Store. We do not collect or store your full payment card information. Apple provides us with a transaction identifier and purchase status to confirm the transaction and deliver purchased items.
...
We store your information through secure means, including local storage (such as device cache) and server logs. We retain your personal information only for as long as necessary to fulfill the purposes described in this Policy or as required by applicable law.
Storage Location
Personal information collected during our operations within the United States is stored within USA. If cross-border transfer is required, we will comply with applicable legal requirements.
Security Measures
We implement industry-reasonable technical measures to protect your personal information, including but not limited to encryption (such as SSL), access controls, and de-identification. We restrict access to your personal information to employees who need to know it and require them to maintain confidentiality.
...
We do not sell your personal information to any third party. In the event of a merger, acquisition, or similar transaction, we will require the successor to be bound by this Policy.
5. Third-Party Advertising and Tracking Technologies
5.1 Ad Display
...
As the Game contains third-party advertising, we recommend that minors use the Game under the guidance of a guardian, who may assist in managing advertising tracking authorization settings.
9. Policy Updates
We may update this Privacy Policy from time to time. Updated policies will be notified to you within the Game or through other appropriate means. Continued use of the Game constitutes acceptance of the updated policy.
10. Contact Us
